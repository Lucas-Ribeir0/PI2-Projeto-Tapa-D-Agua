        ...
        <div className="formLogin">
            ...
            <div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Senha" aria-label="Password" aria-describedby="basic-addon1" required/>
                </div>
                <a href="#"><button type="submit" class="btn btn-primary">Entrar</button></a>
